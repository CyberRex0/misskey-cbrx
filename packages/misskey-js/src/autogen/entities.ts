...
export type UsersAiSummaryRequest = operations['users___ai-summary']['requestBody']['content']['application/json'];
export type UsersAiSummaryResponse = operations['users___ai-summary']['responses']['200']['content']['application/json'];
export type UsersAiSummaryStatusRequest = operations['users___ai-summary___status']['requestBody']['content']['application/json'];
export type UsersAiSummaryStatusResponse = operations['users___ai-summary___status']['responses']['200']['content']['application/json'];
