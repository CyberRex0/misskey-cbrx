...
export type UsersCommonFollowersRequest = operations['users___common-followers']['requestBody']['content']['application/json'];
export type UsersCommonFollowersResponse = operations['users___common-followers']['responses']['200']['content']['application/json'];
